...
MediaSink* MediaSink::Create(const wchar_t *url, IMFMediaType* mfMediaType, Parameters* params)
{
  IMFASFContentInfo *mfAsfContentInfo;
  ...
  HRESULT hr;
    ...
    AudioEncoder::SetEncoderPropertyStoreValuesForQualityBasedVbr(streamPropertyStore, params->Quality);
/*
...
// test    SetInt32PropertyStoreValue(streamPropertyStore, MFPKEY_PASSESUSED, 1);
    ...
    // Set the quality level.
    SetUint32PropertyStoreValue(streamPropertyStore, MFPKEY_DESIRED_VBRQUALITY, 75);
*/
